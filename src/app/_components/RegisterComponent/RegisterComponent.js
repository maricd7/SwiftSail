  ...
  return (
    <div className="w-full flex justify-center items-center">
      ...
      >
        ...
        <Input placeholder="Confirm Password" type="password" label="Confirm Password" ref={confirmPasswordRef}/>
        {errorMessage ? <span className="text-red-500 text-sm">Passwords do not match!</span> : <></> }
        {errorMessage.length>0 ? <span className="text-red-500 text-sm">{errorMessageText}</span>:<></>}
