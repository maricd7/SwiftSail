...
export default function RegisterComponent() {
    ...
    const displayNameRegisterRef = useRef();
    ...
    async function handleSubmit(e) {
        ...
        const displayName = displayNameRegisterRef.current;
  ...
  return (
    <div className="w-full flex justify-center items-center">
      ...
      >
        ...
        <Input placeholder="Display Name" type="text" label="Display Name" ref={displayNameRegisterRef}/>
