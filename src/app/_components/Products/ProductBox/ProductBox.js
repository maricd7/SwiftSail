...
export const ProductBox = ({product}) => {
  ...
  return (
    <a href={productRef} className='rounded-xl max-w-sm   mx-auto mt-8 bg-white rounded overflow-hidden shadow-lg p-4 cursor-pointer hover:border-2 border-orange-400'>
